...
<div id="mainContainer">
  ...
  <div id="leftNav">
   	<a href="../Doctor/index.php" class="leftNavButton">Home</a>
    <a href="../Doctor/registerOGCT.php" class="leftNavButton">Add Health Team</a>
    <a href="../Doctor/registerPatient.php" class="leftNavButton">Add Patient</a>
    <a href="../Doctor/addGoal.php" class="leftNavButton">Add Goal</a>
    <a href="../Doctor/deleteGoal.php" class="leftNavButton">Delete Goal</a><a href="#" class="leftNavButton">Reports</a><a href="../loggedOut.php" class="leftNavButton">Logout</a>
  </div>
  <div id="content">
  
    <!-- TemplateBeginEditable name="content" -->content here<!-- TemplateEndEditable -->
  </div>
