    ...
    <div class="contentHolder"> </br>
      <table width="580" border="0" cellspacing="1" cellpadding="1">
        <tr>
          ...
          <td class="currentStep">Finish</td>
        </tr>
      </table>
      <p class="contentHolderText">Congratulations!</p>
      <p class="contentHolderText">You have successfully completed your registration for weight loss activities.</p>
      <p class="contentHolderText">You will now be re-directed to the follow up page.</p>
