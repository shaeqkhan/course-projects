...
<div id="mainContainer">
  ...
  <div id="leftNav">
   	<a href="Patient/index.php" class="leftNavButton">Home</a>
...
<div class="contentHolder"> </br>
  ...
  <div class="goalsIncrementalWizardTable">
    ...
    <table border="1" cellpadding="1" cellspacing="1">
      ...
      <?php do { ?>
        <tr>
          <td><input type="checkbox" name="eee" id="eee" value="<?php echo 10^($row_incrementalGoals['goal_id']-1); ?>" />
    ...
    <div class="goalsDecrementalWizardTable">
      ...
      <table border="1" cellpadding="1" cellspacing="1">
        ...
        <?php do { ?>
        <tr>
            <td><input type="checkbox" name="eee" id="eee" value="<?php echo 10^($row_decrementalGoals['goal_id']-1); ?>" />
  ...
  <form action="step3.php" method="post" name="form1" class="proceedButton">
    ...
    <input type="submit" name="button" id="button" value="Add Goals and Proceed">
  </form>
