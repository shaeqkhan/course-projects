...
DROP TABLE ALBUMHASPHOTO cascade constraints;
DROP TABLE PHOTOHASCOMMENT cascade constraints;
DROP TABLE PHOTOHASTAG cascade constraints;
DROP TABLE STATUSHASCOMMENT cascade constraints;
DROP TABLE USERHASCOMMENT cascade constraints;
DROP TABLE USERHASCURRENTLOCATION cascade constraints;
DROP TABLE USERHASHOMETOWN cascade constraints;
DROP TABLE USERISFRIEND cascade constraints;
DROP TABLE USERPOSTSSTATUS cascade constraints;
...
INSERT INTO Comments
VALUES(17,'I have many carrots. Lets meet up! :P', systimestamp);

INSERT INTO Comments
VALUES(18,'lol I aint falling for that Sam!',systimestamp);

INSERT INTO Comments
VALUES(19,'Hey bugs, I got a lots of them',systimestamp);

INSERT INTO Comments
VALUES(20,'Thanks bro, will pick them up tonight',systimestamp);
...
/* Pepe LePew's status */
INSERT INTO Status
VALUES(4,'Le looking for a lovely madamoiselle',systimestamp);
