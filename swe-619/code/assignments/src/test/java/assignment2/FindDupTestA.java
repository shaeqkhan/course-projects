...
import assignment2.FindDupA;

import static org.junit.Assert.*;

public class FindDupTestA {
      
    /*
     * Test cases for findDup method, of class FindDupA.
     */
    int[] a;
    int[] b;
    ...
    public void testDuplicate() {
        ...
        int a[] = {7,13,6};
        int b[] = {5,13,5};
        assertEquals(1, FindDupA.findDup(a, b));
    ...
    public void testNullArrays(){
        ...
        int[] a = null;
        int[] b = null;        
        assertEquals(-2, FindDupA.findDup(a, b));
        System.out.println("Null array, return -2, test case succesful \n");       
    }
    ...
    public void testNoCommonElement(){
        ...
        int[] b = {2,1,5};       
        assertEquals(-1, FindDupA.findDup(a, b));
        System.out.println("No common element found, return -1, test case succesful \n");       
    }   
}
