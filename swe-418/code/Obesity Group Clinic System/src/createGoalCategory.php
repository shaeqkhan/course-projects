<?php
	...
	require_once "views/viewCreateGoalCategory.php";
...
<title>Aramco OGC - Create Goal Category</title>
...
<div class="heading">Create Goal Category</div>
    
    <div class="contentBody"><?php viewCreateGoalCategory(); ?><br /></div>
