<?php
	...
	require_once "views/viewCategoryGoals.php";
...
<title>Aramco OGC - Category Details</title>
...
<div class="heading">Category Details</div>
    
    <div class="contentBody"><?php viewGoalsByCtgry($_GET['id']); ?><br /></div>
