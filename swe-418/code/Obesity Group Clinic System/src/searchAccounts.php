<?php
	...
	require_once "views/viewSearchAccount.php";
...
<title>Aramco OGC - Searching Accounts</title>
...
<div class="heading">Searching Accounts</div>
    
    <div class="contentBody"><?php viewSearchPatient(); ?><br /></div>
