<?php
	...
	require_once "views/viewCreateGoal.php";
...
<title>Aramco OGC - Create Goal</title>
...
<div class="heading">Create Goal</div>
    
    <div class="contentBody"><?php viewCreateGoal(); ?><br /></div>
