...
<html>
  <head>
    ...
    function login(){
        ...
        function(data) {
            if(data=="ERROR"){
                //loginMsg.innerHTML = "<li><img src='logging_in.gif'/>Authentication Failed!</li>";
                jQT.goBack();
                alert("Authentication Failed!! Check your credentials and internet connection");
            }
            else{
...
<body>
  ...
  <div id="loginScreen">
    ...
    <ul class="rounded">
      ...
      <li class="arrow"><a href="#patientScreen" onclick="login();" id="loginButton">Login</a></li>
    </ul>
  </div>
  ...
  <div id="patientScreen">
    <div class="toolbar">
      <h1>Aramco OGCS</h1>
      <a id="logoutButton" class="button" onclick=logout(); href="#loginScreen">Logout</a>
    </div>
