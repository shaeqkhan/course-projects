<?php
	...
	require_once "views/viewGoalCategories.php";
...
<title>Aramco OGC - View Goal Category</title>
...
<div class="container">
  ...
  <div class="content">
	...
	<br />
	<br />
<div class="heading">View Category</div>
    
    <div class="contentBody"><?php viewGoalCategory(); ?><br /></div>
