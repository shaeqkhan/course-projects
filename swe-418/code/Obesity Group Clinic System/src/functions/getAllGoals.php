...
require_once("t_config.php");
	...
	function getAllGoals()
	{
		...
		$view_all_goals = "SELECT goal . * , category.category_name FROM goal LEFT JOIN category ON goal.goal_category_id = category.category_id WHERE goal.deleted_flag = 0";
