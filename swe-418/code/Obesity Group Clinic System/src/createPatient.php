<?php
	...
	require_once "views/viewCreatePatient.php";
...
<title>Aramco OGC - Create Patient</title>
...
<div class="container">
  ...
  <div class="content">
	...
	<br />
	<br />
<div class="heading">Create Patient</div>
    
    <div class="contentBody"><?php viewCreatePatient($_POST); ?><br /></div>
